...
class ApidocService
{
     ...
     *
     * Example:
     * @Api(name="menu_by_id", method="get", url_params="?menu={resortId}", parameters={"resortId":{"type":"string"}})
     * or
     * @Api(name="menu_by_id", method="get", url="/newsapp/getapidoc", action_url="getapidoc", url_params="?menu={resortId}", parameters={"resortId":{"type":"string"}})
     *
     * @return array
     * @throws \ReflectionException
     */
